...
VARS="NEXT_PUBLIC_API_URL NEXT_PUBLIC_CLIENT_URL NEXT_PUBLIC_ADMIN_URL NEXT_PUBLIC_DOCS_URL NEXT_PUBLIC_CATWIKI_EDITION NEXT_PUBLIC_DEBUG NEXT_PUBLIC_SENTRY_DSN"
