          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" variant="premium" className="w-full sm:w-auto h-12 px-8 text-base shadow-lg shadow-sky-200/50 hover:shadow-sky-300/50 transition-all rounded-full" asChild>
                <Link href="https://docs.catwiki.ai" target="_blank">
                  立即开始
                </Link>
              </Button>
      ...
      <section id="demos" className="py-24 relative bg-white border-t border-slate-100">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Admin Demo */}
            <a href="https://admin.catwiki.ai" target="_blank" rel="noreferrer" className="group relative p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 block overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm font-mono text-slate-400 bg-slate-50 py-2 px-3 rounded border border-slate-100 truncate group-hover:border-indigo-100 group-hover:text-indigo-500 transition-colors">
                  https://admin.catwiki.ai
                </div>
              </div>
            </a>

            {/* Client Demo */}
            <a href="https://demo.catwiki.ai" target="_blank" rel="noreferrer" className="group relative p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 block overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm font-mono text-slate-400 bg-slate-50 py-2 px-3 rounded border border-slate-100 truncate group-hover:border-sky-100 group-hover:text-sky-500 transition-colors">
                  https://demo.catwiki.ai
                </div>
              </div>
            </a>

            {/* Docs Demo */}
            <a href="https://docs.catwiki.ai" target="_blank" rel="noreferrer" className="group relative p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 block overflow-hidden">
      ...
      <section id="enterprise" className="py-32 bg-slate-50 relative">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            {/* SaaS Plan */}
            <div className="p-8 rounded-[2rem] bg-white border border-slate-200 shadow-sm flex flex-col hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl font-bold text-slate-900 mb-2">SaaS 版本</h3>
              <p className="text-slate-500 mb-6 text-sm h-10">统一运营平台，支持多租户快速开通，即开即用。</p>
              <div className="text-4xl font-bold text-slate-900 mb-6 tracking-tight">SaaS</div>
              ...
              <ul className="space-y-4 mb-8 flex-1">
                { [
                  ...
                  <li key={feature} className="flex items-center text-slate-600 text-sm">
                    <div className="mr-3 bg-sky-100 rounded-full p-1"><Check className="h-3 w-3 text-sky-600" /></div>
                    {feature}
                  </li>
                ))}
              </ul>
            ...
            <div className="p-8 rounded-[2rem] bg-slate-900 text-white shadow-2xl flex flex-col relative overflow-hidden hover:-translate-y-1 transition-all duration-300 border-2 border-sky-500/20">
              <div className="absolute top-0 right-0 bg-sky-500 text-white text-[10px] uppercase font-bold px-3 py-1 rounded-bl-xl tracking-wider">
                Enterprise
              </div>
              <h3 className="text-xl font-bold mb-2 text-white">私有化部署</h3>
              <p className="text-slate-400 mb-6 text-sm h-10">针对大型企业的专属私有化部署与深度技术支持。</p>
              <div className="text-4xl font-bold mb-6 tracking-tight">定制</div>

              <ul className="space-y-4 mb-8 flex-1">
                {["包含所有高级功能", "SSO 单点登录", "私有化部署实施", "定制功能开发", "7x24 专家支持"].map((feature) => (
              ...
              <Button className="w-full bg-sky-500 hover:bg-sky-600 text-white h-10 rounded-full border-0 shadow-lg shadow-sky-500/20">
                联系销售
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="https://docs.catwiki.ai/about/project/changelog" target="_blank" className="hover:text-white transition-colors">更新日志</a></li>
              </ul>
            </div>
            <div>
